export default function Datenschutz(){
    return(
        <div className="law-container">
            <h1>Datenschutz</h1>
            <p>1. Datenschutz auf einen Blick
Allgemeine Hinweise
...
Datenschutzerklärung.
		...
		<p>2. Hosting und Content Delivery Networks (CDN)
Externes Hosting
...
auffordern, Ihre Einwilligung zur Speicherung widerrufen oder der Zweck für die Datenspeicherung entfällt
(z. B. nach abgeschlossener Bearbeitung Ihres Anliegens). Zwingende g
		</p>
		<p>5. Plugins und Tools
Google Web Fonts
...
Der Webseitenbetreiber hat ein berechtigtes Interesse an der einheitlichen Darstellung des Schriftbildes auf seiner Webseite. Sofern eine entsprechende Einwilligung abgefragt wurde (z. B. eine Einwilligung zur
